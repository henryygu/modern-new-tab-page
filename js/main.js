...
function carregarConfigs() {
    ...
    if (Config.getShowSearchBox() == true) {
        $("#search-box").css('display', '');
        $("#chkShowSearchBox").attr("checked", "checked");
    } else {
        $("#search-box").css('display', 'none');
        $("#chkShowSearchBox").removeAttr("checked");
    }
...
function configEvents() {
    ...
    $("#chkShowSearchBox").unbind("change");
    $("#chkShowSearchBox").change(function () {
        if ($(this).is(":checked")) {
            Config.setShowSearchBox(true);
            $("#search-box").show();
        } else {
            Config.setShowSearchBox(false);
            $("#search-box").hide();
        }
    });
