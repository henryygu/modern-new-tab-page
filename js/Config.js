...
// SearchBar
Config.setShowSearchBox = function (show) {
    if (show == true)
        Storage.showSearchBox = 1;
    else
        Storage.showSearchBox = 0;
}

Config.getShowSearchBox = function () {
    if (Storage.showSearchBox == undefined)
        return true;
    else if (Storage.showSearchBox == 1)
        return true;
    else
        return false;
}